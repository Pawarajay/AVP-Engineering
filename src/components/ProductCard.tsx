...
//   description?: string;
//   onClick?: () => void;
//   idx?: number; // For entry animation delay
// }
...
//   // Use inline style for staggered animation
//   const style = {
//     animationDelay: `${(idx ?? 0) * 100}ms`
//   };

//   return (
//     <div
//       className="flex flex-col bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group min-h-80 cursor-pointer animate-fadeInUp"
//       style={style}
//       onClick={onClick}
...
//         <img
//           src={image}
//           alt={description ? description : "Machine component"}
//           className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-110 group-hover:rotate-1 bg-gray-200"
//           onError={handleImgError}
//           loading="lazy"
//         />
//         <div className="absolute inset-0 bg-gradient-to-t from-black/10 to-transparent pointer-events-none" />
//         <span className="absolute top-2 right-2 px-2 py-1 bg-white/80 text-xs rounded text-gray-700 opacity-0 group-hover:opacity-100 transition">
//           Click to enlarge
//         </span>
//       </div>
//       <div className="flex-1 flex items-center justify-center">
//         {description && (
//           <p className="text-gray-700 text-base font-medium px-4 py-3 text-center">
//             {description}
//           </p>
//         )}
//       </div>
