    ...
    <section className="py-12 md:py-16 lg:py-20 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 md:mb-12 lg:mb-16 animate-fade-in">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold mb-3 md:mb-4 text-primary">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-10 md:mb-12">
          {exportBenefits.map((benefit, index) => (
            <Card
              key={index}
              className="text-center hover:shadow-lg transition-all duration-300 animate-scale-in bg-white border-slate-200"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <CardContent className="p-4 md:p-6">
                <benefit.icon className="h-8 w-8 md:h-10 md:w-10 mx-auto mb-2 md:mb-3 text-blue-600" />
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 lg:p-8">
          <Tabs defaultValue="machinery" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-4 gap-2 mb-6 md:mb-8 h-auto bg-slate-100 p-2 rounded-lg">
              <TabsTrigger value="machinery" className="py-2 md:py-3 text-xs md:text-sm flex-col md:flex-row gap-1 md:gap-2 data-[state=active]:bg-white">
                <Settings className="h-4 w-4 md:h-5 md:w-5" />
                <span>Machinery</span>
              </TabsTrigger>
              <TabsTrigger value="spare-parts" className="py-2 md:py-3 text-xs md:text-sm flex-col md:flex-row gap-1 md:gap-2 data-[state=active]:bg-white">
                <Package className="h-4 w-4 md:h-5 md:w-5" />
                <span>Spare Parts</span>
              </TabsTrigger>
              <TabsTrigger value="fishnets" className="py-2 md:py-3 text-xs md:text-sm flex-col md:flex-row gap-1 md:gap-2 data-[state=active]:bg-white">
                <Network className="h-4 w-4 md:h-5 md:w-5" />
                <span>Fishnets</span>
              </TabsTrigger>
              <TabsTrigger value="custom" className="py-2 md:py-3 text-xs md:text-sm flex-col md:flex-row gap-1 md:gap-2 data-[state=active]:bg-white">
            ...
            {/* Machinery Tab */}
            <TabsContent value="machinery" className="animate-fade-in mt-0">
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
                <div className="order-2 lg:order-1">
                  ...
                  <p className="text-base md:text-lg text-slate-600 mb-5 md:mb-6">
                  ...
                  <div className="space-y-3 md:space-y-4 mb-5 md:mb-6">
                    <h4 className="font-heading font-semibold text-lg md:text-xl text-blue-600">Product Range:</h4>
                    {machineryProducts.map((product, idx) => (
                      <div key={idx} className="flex items-start space-x-3 p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <Card className="bg-blue-600 text-white mb-5 md:mb-6 border-0">
                    <CardContent className="p-4 md:p-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                    <Button onClick={scrollToContact} size="lg" className="bg-blue-600 hover:bg-blue-700 w-full sm:w-auto">
                      Request Machinery Catalog
                    </Button>
                    <Button onClick={scrollToContact} size="lg" variant="outline" className="w-full sm:w-auto">
                      Get Export Quote
                    </Button>
                  </div>
                </div>
            ...
            {/* Spare Parts Tab */}
            <TabsContent value="spare-parts" className="animate-fade-in mt-0">
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
                <div>
                  <img
                    src={sparePartsImage}
                ...
                <div>
                  ...
                  <div className="space-y-3 md:space-y-4 mb-5 md:mb-6">
                    <h4 className="font-heading font-semibold text-lg md:text-xl text-blue-600">Available Categories:</h4>
                    {sparePartsCategories.map((category, idx) => (
                      <div key={idx} className="p-3 md:p-4 bg-slate-50 rounded-lg border border-slate-200">
                  ...
                  <Card className="bg-emerald-600 text-white mb-5 md:mb-6 border-0">
                    <CardContent className="p-4 md:p-6">
            ...
            {/* Fishnets Tab */}
            <TabsContent value="fishnets" className="animate-fade-in mt-0">
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
                <div className="order-2 lg:order-1">
                  <h3 className="text-2xl md:text-3xl font-heading font-bold mb-3 md:mb-4 text-primary">
                  ...
                  <div className="space-y-3 md:space-y-4 mb-5 md:mb-6">
                    <h4 className="font-heading font-semibold text-lg md:text-xl text-blue-600">Product Types:</h4>
                  ...
                  <Card className="bg-gradient-to-br from-blue-600 to-blue-700 text-white mb-5 md:mb-6 border-0">
                    <CardContent className="p-4 md:p-6">
            ...
            <TabsContent value="custom" className="animate-fade-in mt-0">
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
                <div>
                  <img
                    src={customImage}
                ...
                <div>
                  ...
                  <Card className="mb-5 md:mb-6 bg-slate-50 border-slate-200">
                    <CardHeader className="pb-3">
                      <CardTitle className="text-lg md:text-xl text-primary">Our Custom Build Process:</CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        {/* Bottom CTA */}
        {/* <Card className="mt-10 md:mt-12 lg:mt-16 bg-gradient-to-br from-blue-600 to-blue-700 text-white animate-fade-in border-0 shadow-xl">
          <CardContent className="p-8 md:p-10 lg:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 md:gap-4">
              <Button onClick={scrollToContact} size="lg" className="bg-white text-blue-600 hover:bg-slate-100 w-full sm:w-auto">
                Request International Quote
              </Button>
              <Button onClick={scrollToContact} size="lg" variant="outline" className="border-white text-white hover:bg-white/10 w-full sm:w-auto">
